...
class Authorization extends ControllerBase {
  ...
  public function authorize() {
    ...
    try {
      ...
      \Drupal::messenger()->addMessage($this->t('Your Fitbit account is now connected.'));
      ...
      \Drupal::messenger()->addError($this->t('Your Fitbit account could not be connected. ' . $e->getMessage()));
      return new RedirectResponse(Url::fromRoute('entity.user.canonical', ['user' => $this->currentUser->id()])->toString());
    }
  }
